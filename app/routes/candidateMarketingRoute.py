...
@router.get("/candidatemarketing/{candidate_marketing_id}")
...
@router.put("/candidatemarketing/{candidate_marketing_id}")
...
@router.delete("/candidatemarketing/{candidate_marketing_id}")
