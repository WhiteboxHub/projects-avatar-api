...
# from app.models import CurrentMarketing, Candidate
...
#     existing_current_marketing = db.query(CurrentMarketing).filter(CurrentMarketing.id == current_marketing_id).first()
